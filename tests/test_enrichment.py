"""
Automated Pytest for meld-na-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    PhosphateBinderOptimizationEngine,
    MeldnacalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = MeldnacalculatorEnrichmentSuite()
