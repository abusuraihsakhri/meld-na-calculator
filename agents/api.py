"""
FastAPI REST API Server for Meld Na Calculator.
"""
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "meld-na-calculator", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
