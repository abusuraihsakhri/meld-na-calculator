...
class AuditTrail:
    ...
    def __init__(self, secret_key: Optional[str] = None):
        ...
        # NOTE: For production, always set AUDIT_SECRET_KEY env var for consistent verification
        key = secret_key or os.getenv("AUDIT_SECRET_KEY") or secrets.token_hex(32)
